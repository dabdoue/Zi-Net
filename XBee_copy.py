...
class XBee():
    ...
    def SendStr(self, msg, addr=0xCE44, options=0x01, frameid=0x00):
        """
        Inputs:
    ...
    def Send(self, msg, addr=0x9DC7, options=0x01, frameid=0x00):
        """
        Inputs:
        ...
        hexs = '7E 00 7D 33 10 01 00 00 00 00 00 00 00 00 00 00 00 00 68 65 6C 6C 6F DA'
